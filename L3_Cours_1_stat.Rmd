...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/5-Stat/plotly-example-plots.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/5-Stat/histo.png")
```
] 
...
knitr::include_graphics("./assets/images/5-Stat/histo-barre.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/5-Stat/billou.png")
```
] 
...
.center-img[
```{r echo=FALSE, out.width="70%"}
knitr::include_graphics("./assets/images/5-Stat/centrale.png")
```
]
...
df.prof <-
  df.prof %>% rename('Notes du prof. X' = Notes.du.Pr..X , 'Notes du prof. Y' = Notes.du.Pr..Y)
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/loi_normale.png")
```
]]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/normal.gif")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_1.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_2.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_3.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_4.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_5.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_6.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/var_7.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("./assets/images/5-Stat/quantiles.png")
```
] 
...
.pull-right[.center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/boxplot.png")
```
]]
...
knitr::include_graphics("./assets/images/5-Stat/skew.png")
```
] ]
...
.pull-right[ .center-img[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/5-Stat/applat.png")
```
] ]
